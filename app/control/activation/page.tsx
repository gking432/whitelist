        ...
        <section className="flex flex-col gap-4 border-b pb-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">
              This page checks whether each required account is configured without exposing any secret value. Add missing values in the hosting environment, redeploy, and return here.
            </p>
          </div>
          <div className="min-w-48 rounded-lg border bg-card px-4 py-3">
            <p className="text-2xl font-semibold tabular-nums">
              {activation.coreComplete}/{activation.coreTotal}
            </p>
            <p className="text-xs text-muted-foreground">Core launch systems ready</p>
          </div>
        </section>
