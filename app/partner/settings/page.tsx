    ...
    >
      <div className="space-y-6">
        <header className="flex flex-col gap-3 border-b pb-5 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-semibold">White-label settings</h1>
            </div>
            <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
              Manage the product identity applied to every CRM and client
              workspace your agency sells.
            </p>
          </div>
        ...
        <section aria-labelledby="branding-heading" className="space-y-5">
          <div>
            <h2 id="branding-heading" className="font-semibold">
              Branding
            </h2>
            <p className="mt-1 text-sm leading-6 text-muted-foreground">
              These settings are established during partner onboarding and can
